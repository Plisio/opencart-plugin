...
<div id="content">
  ...
  <div class="invoice__wrapper container">
        ...
        <div class="invoice__content">
            ...
            <?php elseif ($status == 'pending' && $pending_amount <= 0): ?>
              <div class="invoice__result text-center">
                ...
                <a href="<?php echo htmlspecialchars($txUrl); ?>" title="Check my transaction" target="_blank"
                   rel="noopener">
            ...
            <?php elseif ($status == 'mismatch'): ?>
              <div class="invoice__result text-center">
                ...
                <p>You have
                  payed <?php echo (float)$amount + (float)$pending_amount * (-1); ?> <?php echo htmlspecialchars($currency); ?>
                  ,
            ...
            <?php elseif (in_array($status, ['expired', 'cancelled'])): ?>
                ...
                <div class="invoice__result text-center">
                  ...
                  <p>We have
                    received <?php echo (float)$amount - (float)$pending_amount; ?> <?php echo htmlspecialchars($currency); ?>
    ...
    <?php /* bootstrap 2.2.2 is need for after-copy tooltips */ ?>
